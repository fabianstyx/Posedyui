...
class Preferences(context: Context)
{
        ...
        val poseTrackerEnabledKey get() = resources.getString(R.string.preferences_pose_tracker_enabled_key)
        var poseTrackerEnabled
                get() = sharedPreferences.getBoolean(poseTrackerEnabledKey, false)
                set(value) { sharedPreferences.edit().putBoolean(poseTrackerEnabledKey, value).apply() }

        val poseTrackerVisualAssistKey get() = resources.getString(R.string.preferences_pose_tracker_visual_assist_key)
        var poseTrackerVisualAssist
                get() = sharedPreferences.getBoolean(poseTrackerVisualAssistKey, true)
                set(value) { sharedPreferences.edit().putBoolean(poseTrackerVisualAssistKey, value).apply() }
